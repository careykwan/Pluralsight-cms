...
<div class="home">
        <div class="home-hero-section">
            <div class="hero-content">
                ...
                <button class="button button-home button-purple"><a href="http://192.168.33.10/new_project/classes/">View Class Schedule</a></button>
                <button class="button button-home button-pink"><a href="http://192.168.33.10/new_project/about/events/">Upcoming Events</a></button>
            </div>
        </div>
